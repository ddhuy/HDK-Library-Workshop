...
public class TestData {
    ...
    public void bookData() {
        ...
        allBooks.get(2).addCopy();
        DataAccessFactory.defaultDataAccess().loadBookMap(allBooks);
    }

    public void userData() {
        DataAccessFactory.defaultDataAccess().loadUserMap(allUsers);
    }
    ...
    public void libraryMemberData() {
        ...
        DataAccessFactory.defaultDataAccess().loadMemberMap(members);
    }
